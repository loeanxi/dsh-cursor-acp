 ...
 */
import { normalizeModel, parseEffort, splitCursorModelId, } from './models.js';
 ...
 */
export function parseCursorAcpSettings(input) {
 ...
 */
export function createCursorAcpSettingsSchema() {
    const parse = (input) => parseCursorAcpSettings(input);
